...
const RELEASE_LINE = 'public_architecture_static_catalog_runtime_module_extraction_gate';
...
1. AGENTS.md â€” human and agent operating rules.
2. llms.txt â€” AI-readable public entrypoint.
3. .agent-onboard/authority-path.json â€” machine-readable authority path index.
4. agent-onboard.target.json â€” target boundary declaration.
5. .agent-onboard/runtime-namespace.json â€” target runtime namespace declaration.
6. .agent-onboard/project.json â€” target runtime identity.
7. .agent-onboard/work-items.json â€” public work item ledger.
8. README.md â€” public package or repository documentation.
9. Raw evidence/source files â€” on demand only after the authority files above.
