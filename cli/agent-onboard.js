...
const { createPublicArchitectureAggregateCheckService } = require('./agent_onboard/domains/architecture/services/checks/architecture-check-service');
const { createPublicArchitectureSourceDomainService } = require('./agent_onboard/domains/architecture/services/source-domains/architecture-source-domain-service');
